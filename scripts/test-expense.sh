...
echo "Payload: \$250.00 travel expense by alice@company.com"

# Create a temporary payload
PAYLOAD='{"amount":250.00,"submitter":"alice@company.com","category":"travel","description":"Flight to NYC for client meeting","date":"2026-04-10"}'
